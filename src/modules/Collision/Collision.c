...
undefined4 KartCollide_validate_805701c0(int param_1)
...

{
  ...
  iVar1 = (**(code **)(*param_2 + 0x138))(param_2,param_5,param_7);
  if (iVar1 == 0) {
    uVar2 = 0;
  }
  else {
    ...
    if ((iVar1 != 0) &&
       (iVar1 = (**(code **)(*param_2 + 0x13c))(param_2,param_5,param_7), iVar1 != 0)) {
      uVar2 = 1;
    }
  }
  return uVar2;
...

{
  ...
  iVar1 = (**(code **)(*param_2 + 0x140))(param_2,param_5,param_7);
  if (iVar1 == 0) {
    uVar2 = 0;
  }
  else {
    ...
    if ((iVar1 != 0) &&
       (iVar1 = (**(code **)(*param_2 + 0x144))(param_2,param_5,param_7), iVar1 != 0)) {
      uVar2 = 1;
    }
  }
  return uVar2;
...

{
  ...
  iVar1 = (**(code **)(*param_1 + 0x140))(param_1,param_4,param_6);
  if (iVar1 == 0) {
    uVar2 = 0;
  }
  else {
    ...
    if ((iVar1 != 0) &&
       (iVar1 = (**(code **)(*param_1 + 0x144))(param_1,param_4,param_6), iVar1 != 0)) {
      uVar2 = 1;
    }
  }
  return uVar2;
...

{
  ...
  iVar1 = (**(code **)(*param_1 + 0x138))(param_1,param_4,param_6);
  if (iVar1 == 0) {
    uVar2 = 0;
  }
  else {
    ...
    if ((iVar1 != 0) &&
       (iVar1 = (**(code **)(*param_1 + 0x13c))(param_1,param_4,param_6), iVar1 != 0)) {
      uVar2 = 1;
    }
  }
  return uVar2;
...
void col_KartCollide_80570ff0(int param_1,int param_2,undefined4 *param_3)
...
void col_KartCollide_805712f0(undefined8 param_1,int *param_2)

{
  undefined8 uVar1;
  
  uVar1 = (**(code **)(*param_2 + 0xa0))();
  (**(code **)(*param_2 + 0xe4))(uVar1,param_1,param_2);
  return;
}

// === col_KartCollide_80571360 (0x80571360) ===
void col_KartCollide_80571360(int *param_1,undefined4 param_2,undefined4 param_3)

{
  undefined4 uVar1;
  
  uVar1 = (**(code **)(*param_1 + 0xb4))();
  FUN_segment_0__807104f0(param_2,uVar1,param_3);
  return;
}

// === col_KartCollide_805713cc (0x805713cc) ===
void col_KartCollide_805713cc(undefined4 param_1)
  ...
  if (iVar4 != 0) {
    *(undefined *)(param_1 + 0x130) = 1;
    if (fRam00000060 < local_40) {
      *(undefined4 *)(param_1 + 0x118) = local_64;
      *(undefined4 *)(param_1 + 0x11c) = local_60;
      *(undefined4 *)(param_1 + 0x120) = local_5c;
    }
    uVar3 = *(ushort *)(param_1 + 0x2c) | 1;
    fVar1 = (fRam00000038 - fRam0000003c) - fRam00000040;
    *(ushort *)(param_1 + 0x2c) = uVar3;
    *(float *)(param_1 + 0x30) =
    ...
    *(float *)(param_1 + 0x38) =
    ...
    if (((local_108[0] & 0x2000) == 0) && (*(int *)(param_1 + 0x134) != 1)) {
      ...
      *(undefined4 *)(param_1 + 0x10c) = local_e0;
      *(undefined4 *)(param_1 + 0x110) = local_dc;
      *(undefined4 *)(param_1 + 0x114) = local_d8;
      if (*(int *)(param_1 + 0x134) == 2) {
        FUN_segment_0__804470ec
                  ((double)g_Ram_float,(double)fRam00000050,
                   *(undefined4 *)(*(int *)(param_1 + 8) + 0x28),3);
      ...
      *(undefined *)(param_1 + 0x130) = 0;
      ...
      if (*(float *)(iVar5 + 4) <= *(float *)(iVar4 + 4)) {
        ...
        *(undefined4 *)(param_1 + 0x10c) = local_f8;
        *(undefined4 *)(param_1 + 0x110) = local_f4;
        *(undefined4 *)(param_1 + 0x114) = local_f0;
      }
      else {
        FUN_segment_0__80404498(&local_ec,iVar5,param_1 + 0xdc);
        *(undefined4 *)(param_1 + 0x10c) = local_ec;
        *(undefined4 *)(param_1 + 0x110) = local_e8;
        *(undefined4 *)(param_1 + 0x114) = local_e4;
      }
...

{
  ...
  *(undefined4 *)(param_1 + 0x158) = *(undefined4 *)(param_1 + 0x10c);
  dVar1 = (double)CONCAT44(g_Ram_float,uRam00000004);
  *(undefined4 *)(param_1 + 0x15c) = *(undefined4 *)(param_1 + 0x110);
  *(undefined4 *)(param_1 + 0x160) = *(undefined4 *)(param_1 + 0x114);
  *(float *)(param_1 + 0x168) =
...

{
  ...
  *(undefined4 *)(param_1 + 0x16c) = *(undefined4 *)(param_1 + 0x10c);
  uVar3 = (uint)*(ushort *)(param_1 + 0x154);
  *(undefined4 *)(param_1 + 0x170) = *(undefined4 *)(param_1 + 0x110);
  *(undefined4 *)(param_1 + 0x174) = *(undefined4 *)(param_1 + 0x114);
  ...
  if ((int)uVar3 < (int)g_Ram_float) {
    ...
    *(undefined4 *)(param_1 + 0x10c) = *(undefined4 *)(param_1 + 0x16c);
    *(undefined4 *)(param_1 + 0x110) = *(undefined4 *)(param_1 + 0x170);
    *(undefined4 *)(param_1 + 0x114) = *(undefined4 *)(param_1 + 0x174);
    *(undefined4 *)(param_1 + 0x178) = *(undefined4 *)(param_1 + 0x164);
  }
  else {
...

{
  ...
  *(undefined4 *)(param_1 + 0x100) = local_18;
  *(undefined4 *)(param_1 + 0x104) = local_14;
  *(undefined4 *)(param_1 + 0x108) = local_10;
                    /* WARNING: Subroutine does not return */
...
void col_Hitbox_805b7c50(undefined4 param_1)
...
undefined4 Hitbox_validate_805b84b8(undefined4 *param_1)
...

{
  ...
  for (iVar4 = 0; fVar1 = g_Ram_float, iVar4 < *(int *)(param_1 + 0x100); iVar4 = iVar4 + 1) {
    *(undefined4 *)(*(int *)(param_1 + 0x120) + iVar3) = 600;
    iVar3 = iVar3 + 4;
  }
  iVar4 = 0;
...
LAB_segment_0__805ba160:
    if ((bVar5) && (iVar4 == -1)) {
      ...
      *(int *)(*(int *)(*(int *)(param_1 + 0xb8) + iVar2 * 4) + 0xb4) = param_2;
      ...
      FUN_segment_0__804470ec(dVar8,(double)g_Ram_float,*(undefined4 *)(piVar7[2] + 0x28),0);
      *(undefined *)(piVar7 + 0x2c) = 1;
      (**(code **)(*piVar7 + 0x68))(piVar7,1);
    }
  }
  return;
}
...

{
  ...
  for (iVar3 = 0; iVar3 < *(int *)(param_1 + 0x100); iVar3 = iVar3 + 1) {
    ...
    for (iVar4 = 0; iVar4 < *(int *)(param_1 + 0xec); iVar4 = iVar4 + 1) {
      if ((*(char *)(iVar3 + *(int *)(*(int *)(param_1 + 0xd8) + iVar2) + 0x1b1) != 0) &&
        ...
        *(undefined4 *)(iVar1 + *(int *)(param_1 + 0x120)) = 0;
      }
      iVar2 = iVar2 + 4;
    }
    iVar1 = iVar1 + 4;
  ...
  for (iVar1 = 0; iVar1 < *(int *)(param_1 + 0xec); iVar1 = iVar1 + 1) {
    FUN_segment_0__805bec64(*(undefined4 *)(*(int *)(param_1 + 0xd8) + iVar3));
    iVar3 = iVar3 + 4;
  }
  iVar1 = 0;
  for (iVar3 = 0; iVar3 < *(int *)(param_1 + 0x100); iVar3 = iVar3 + 1) {
    *(int *)(*(int *)(param_1 + 0x120) + iVar1) = *(int *)(*(int *)(param_1 + 0x120) + iVar1) + 1;
    if (600 < *(int *)(*(int *)(param_1 + 0x120) + iVar1)) {
      *(undefined4 *)(*(int *)(param_1 + 0x120) + iVar1) = 600;
    }
    iVar1 = iVar1 + 4;
  }
  return;
  ...
  do {
    ...
    if (*(char *)(piVar1 + 0x6c) != 0) {
      ...
      for (iVar4 = 0; iVar4 < *(int *)(param_1 + 0xe4); iVar4 = iVar4 + 1) {
        ...
        iVar2 = (**(code **)(*piVar1 + 0xd0))(piVar1,uVar3,&local_28);
        if (iVar2 != 0) {
          FUN_segment_0__807089b4(*(undefined4 *)(*(int *)(param_1 + 0xd4) + iVar5));
        }
        iVar5 = iVar5 + 4;
      }
    }
    ...
    if (*(char *)(iVar1 + 0x1bd) == 0) {
      if (param_2 == iVar1) {
        ...
        iVar1 = FUN_segment_0__805cd26c
                           ...
                           *(int *)(iVar1 + 0x20),*(undefined2 *)(param_2 + 0x1f0),
                           *(undefined2 *)(param_2 + 0x1f8));
      }
      else {
        iVar1 = 0;
      }
...
undefined4 col_Hitbox_805babd0(int param_1,int param_2,int param_3)

{
  ...
  if (param_2 == param_3) {
    ...
    if (*(short *)(iVar3 + 4) == *(short *)(*(int *)(param_3 + 0x20) + 4)) {
      ...
      if (*(short *)(iVar3 + 4) == 0) {
        uVar1 = *(ushort *)(*(int *)(param_1 + 0x104) + *(short *)(iVar3 + 0x48) * 2);
        uVar5 = *(ushort *)(*(int *)(param_1 + 0x104) + *(short *)(iVar3 + 0x46) * 2) - 2 & 0xffff;
        if (uVar5 == 0xffffffff) {
          iVar3 = FUN_segment_0__805d0f48(g_Ram_float,1);
          uVar5 = *(ushort *)(iVar3 + 8) - 1 & 0xffff;
        }
        else if (uVar5 == 0xfffffffe) {
          iVar3 = FUN_segment_0__805d0f48(g_Ram_float,1);
          uVar5 = *(ushort *)(iVar3 + 8) - 2 & 0xffff;
        }
        uVar4 = uVar1 + 2 & 0xffff;
        iVar3 = FUN_segment_0__805d0f48(g_Ram_float,1);
        if (uVar4 == *(ushort *)(iVar3 + 8)) {
          uVar4 = 0;
        }
        else {
          iVar3 = FUN_segment_0__805d0f48(g_Ram_float,1);
          if (uVar4 == *(ushort *)(iVar3 + 8) + 1) {
            uVar4 = 1;
          }
        }
      }
      else {
        uVar5 = *(ushort *)(*(int *)(param_1 + 0x108) + *(short *)(iVar3 + 0x46) * 2) - 2 & 0xffff;
        uVar4 = *(ushort *)(*(int *)(param_1 + 0x108) + *(short *)(iVar3 + 0x48) * 2) + 2 & 0xffff;
        iVar3 = FUN_segment_0__805d0f48(g_Ram_float,0);
        if (*(ushort *)(iVar3 + 8) <= uVar4) {
          uVar4 = 0;
        }
      }
      uVar2 = FUN_segment_0__805cd26c
                        ((double)g_Ram_float,(double)g_Ram_float,*(undefined4 *)(param_3 + 0x20),
                         uVar5,uVar4);
    }
  }
  return uVar2;
...
void col_Hitbox_805bad9c(undefined4 param_1)
...
void col_Hitbox_805baea4(undefined4 param_1)
...
void col_Hitbox_805bafac(undefined4 param_1)
...
void col_CollisionDetection_805bb070(undefined4 param_1)
...
undefined4 CollisionDetection_validate_805bbb18(undefined4 *param_1)
...
void col_CollisionDetection_805bbbe8(undefined4 param_1)
...
undefined4 CollisionDetection_calc_805bc9e0(int *param_1,int param_2,undefined4 param_3,int param_4)
  ...
  if (param_4 == 3) {
    if (*(char *)((int)param_1 + 0x1bd) == 0) {
      if ((param_2 != 0) && (*(int *)(param_2 + 4) == 9)) {
        *(undefined *)(param_1 + 0x86) = 1;
      }
      if (param_1[0x55] == 2) {
        FUN_segment_0__805bd1b8(param_1);
      }
      else {
        *(undefined *)((int)param_1 + 0x1bd) = 1;
        *(undefined *)(param_1 + 0x88) = 0;
        *(undefined *)((int)param_1 + 0x221) = 0;
        param_1[0x70] = 0;
...

{
  ...
  if (iVar1 != 0) {
    ...
    (**(code **)(*piVar2 + 0x10))(piVar2,param_1 + 0x16,param_1 + 0xf,param_1 + 0x5a);
    FUN_segment_0__80701bcc(param_1);
...
// Stub: decompiled source not found for 80570c4c
...
// Stub: decompiled source not found for 80570dbc
...
// Stub: decompiled source not found for 80570e18
...
// Stub: decompiled source not found for 80570eec
...
// Stub: decompiled source not found for 8057130c
...
// Stub: decompiled source not found for 8057166c
...
// Stub: decompiled source not found for 80571754
...
// Stub: decompiled source not found for 805b72ac
...
// Stub: decompiled source not found for 805b8c0c
...
// Stub: decompiled source not found for 805b9e10
...
// Stub: decompiled source not found for 805ba430
void __ct__Q24Kart6HitboxFv(void) { return; }

// === reset__Q24Kart6HitboxFv (0x805ba46c) ===
// Stub: decompiled source not found for 805ba46c
...
// Stub: decompiled source not found for 805ba4a4
...
// Stub: decompiled source not found for 805ba9a8
...
// Stub: decompiled source not found for 805bab90
...
// Stub: decompiled source not found for 805bac44
...
// Stub: decompiled source not found for 805bad24
