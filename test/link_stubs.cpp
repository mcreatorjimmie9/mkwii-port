...
// GX stubs (Phase 32: linktest doesn't link gx_renderer.cpp)
#define STUB_GX(name) extern "C" void name() { }
STUB_GX(GXSetFog)
STUB_GX(GXSetFogRangeAdj)
STUB_GX(GXInitFogAdjTable)
STUB_GX(GXInit)
STUB_GX(GXFlush)
STUB_GX(GXDrawDone)
STUB_GX(GXSetDrawSync)
STUB_GX(GXSetDrawSyncCallback)
STUB_GX(GXBegin)
STUB_GX(GXEnd_impl)
STUB_GX(GXPosition3f32)
STUB_GX(GXPosition2f32)
STUB_GX(GXColor1u32)
STUB_GX(GXColor4u8)
STUB_GX(GXTexCoord2f32)
STUB_GX(GXTexCoord2u16)
STUB_GX(GXNormal3f32)
STUB_GX(GXNormal3s16)
STUB_GX(GXClearVtxDesc)
STUB_GX(GXSetVtxDesc)
STUB_GX(GXSetVtxAttrFmt)
STUB_GX(GXInvalidateVtxCache)
STUB_GX(GXSetNumTexGens)
STUB_GX(GXSetTexCoordGen)
STUB_GX(GXSetNumChans)
STUB_GX(GXSetChanCtrl)
STUB_GX(GXSetChanMatColor)
STUB_GX(GXSetNumIndStages)
STUB_GX(GXSetNumTevStages)
STUB_GX(GXSetTevOp)
STUB_GX(GXSetTevOrder)
STUB_GX(GXSetTevColorIn)
STUB_GX(GXSetTevAlphaIn)
STUB_GX(GXSetTevColorOp)
STUB_GX(GXSetTevAlphaOp)
STUB_GX(GXSetTevColor)
STUB_GX(GXSetTevKColor)
STUB_GX(GXSetTevKColorSel)
STUB_GX(GXSetTevKAlphaSel)
STUB_GX(GXSetTevSwapModeTable)
STUB_GX(GXSetTevSwapMode)
STUB_GX(GXSetTevDirect)
STUB_GX(GXSetBlendMode)
STUB_GX(GXSetColorUpdate)
STUB_GX(GXSetAlphaUpdate)
STUB_GX(GXSetZMode)
STUB_GX(GXSetZCompLoc)
STUB_GX(GXSetCoPlanar)
STUB_GX(GXSetClipMode)
STUB_GX(GXSetCullMode)
STUB_GX(GXSetLineWidth)
STUB_GX(GXSetProjection)
STUB_GX(GXLoadPosMtxImm)
STUB_GX(GXSetCurrentMtx)
STUB_GX(GXSetViewport)
STUB_GX(GXSetScissor)
STUB_GX(GXCopyDisp)
STUB_GX(GXSetDispCopySrc)
STUB_GX(GXSetDispCopyDst)
STUB_GX(GXSetDispCopyYScale)
STUB_GX(GXInitTexObj)
STUB_GX(GXInitTexObjLOD)
STUB_GX(GXLoadTexObj)
STUB_GX(GXInvalidateTexAll)
STUB_GX(GXSetTexWrapMode)
STUB_GX(GXInitLightColor)
STUB_GX(GXInitLightPos)
STUB_GX(GXInitLightDir)
STUB_GX(GXInitSpecularDir)
STUB_GX(GXInitLightSpot)
STUB_GX(GXInitLightAttnA)
STUB_GX(GXInitLightDistAttn)
STUB_GX(GXInitLightAttnK)
STUB_GX(GXInitLightAttn)
STUB_GX(GXLoadLightObjImm)
STUB_GX(GXSetNumLights)
STUB_GX(GXSetAlphaCompare)
STUB_GX(GXCallDisplayList)
STUB_GX(GXCmd1u8)
STUB_GX(GXCmd1u16)
STUB_GX(GXCmd1u32)
STUB_GX(GXGetGPFifo)
STUB_GX(GXGetFifoPtrs)
STUB_GX(GXGetGPStatus)
STUB_GX(GXEnableBreakPt)
STUB_GX(GXDisableBreakPt)
#undef STUB_GX
