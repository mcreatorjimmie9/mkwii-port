...
// Collision flags used in KartCollisionInfo
...
/// and is transformed to world coordinates each frame.
class Hitbox {
public:
    BspHitbox* bsp;
    f32 radius;
    ...
    EGG::Vector3f pos;
    /// Previous frame position (used for sweep tests)
    EGG::Vector3f lastPos;
    /// Position in kart-local coordinates (before rotation/translation)
    EGG::Vector3f relPos;
