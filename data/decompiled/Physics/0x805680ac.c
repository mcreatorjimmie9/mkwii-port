...
// Address: 0x805680ac (section offset: 0x055810)
// Size: 240 bytes, 60 instructions
// Module: StaticR.rel | Class: Physics

void sub_805680ac(void* arg0) {
        ...
        *(uint32_t*)(0x30(r30)) = f0; // stfs
        ...
        // branch to 0x055890
            ...
            *(uint32_t*)(0x34(r30)) = r0; // sth
            float f1 = *(float*)(0x100(r30)); // lfs
            /* li r0, 0 */ // 0x38000000
            float f0 = *(float*)(0x104(r30)); // lfs
            r3 = r30; // mr
            *(uint32_t*)(0x18(r30)) = f1; // stfs
